...
public class TranslationFile {
     ...
     * @param file
     */
    public TranslationFile(TranslationFile file) {
     ...
     * @param fileName
     */
    public TranslationFile(int fileID, String fileName) {
        this.fileID = fileID;
    ...
    /**
     * Adds the segment to the end of the activeSegs list in TranslationFile. Throws
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TranslationFile)) {
            return false;
        }

        TranslationFile m = (TranslationFile) o;
    ...
    static public HashSet<Segment> getAllCommittedSegsInFileList(List<TranslationFile> fileList) {
