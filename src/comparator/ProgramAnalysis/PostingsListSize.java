 ...
 */
package comparator.ProgramAnalysis;
...
public class PostingsListSize {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ArrayList<BasicFile> allFiles = DatabaseOperations.getAllFiles();
        int numSegs = BasicFile.getAllCommittedSegsInFileList(allFiles).size();
        int totalSourceLength = BasicFile.getAllCommittedSegsInFileList(allFiles).stream()
        ...
        pl1.addMultipleSegments(BasicFile.getAllCommittedSegsInFileList(allFiles));
        ...
        pl2.addMultipleSegments(BasicFile.getAllCommittedSegsInFileList(allFiles));
        ...
        pl3.addMultipleSegments(BasicFile.getAllCommittedSegsInFileList(allFiles));
