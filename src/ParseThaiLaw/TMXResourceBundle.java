 ...
 * info@tecnick.com <br/>
 * Project homepage:
 * <a href="http://tmxjavabridge.sourceforge.net" target="_blank">http://tmxjavabridge.sourceforge.net</a><br/>
...
public class TMXResourceBundle extends ResourceBundle {
     ...
     *
     * @param xmlfile the TMX (XML) file to read, supports also URI resources or
     * JAR resources
     ...
     * @param validating If true, the contents is validated against the DTD
